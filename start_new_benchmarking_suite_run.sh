...
sh ~/MA-Scripts/reoptimizer_benchmark_suite.sh suite-logs-thor-wout-$1 && sh ~/MA-Scripts/create_and_copy_select_repo.sh && sh ~/MA-Scripts/reoptimizer_benchmark_suite.sh suite-logs-thor-with-$1 && mv ~/.rheem/executions.json ~/.rheem/executions_before_training-$1.json && mv ~/MA-Scripts/benchmark-thor.properties ~/MA-Scripts/benchmark-thor_before_training-$1.properties 


#cp ~/MA-Scripts/benchmark-thor-blank.properties ~/MA-Scripts/benchmark-thor.properties && sh ~/MA-Scripts/reoptimizer_benchmark_suite_training.sh suite-logs-thor-training-$1 && sh ~/MA-Scripts/create_and_copy_select_repo.sh && sh ~/MA-Scripts/reoptimizer_benchmark_suite_only_wc_sindy.sh suite-logs-thor-only-$1
